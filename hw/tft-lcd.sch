...
$EndDescr
$Comp
L usevolt:HEADER_MOLEX_54104-4031 J301
U 1 1 58FC4B22
P 9550 3250
...
YU
$Comp
L power1:GND #PWR0308
U 1 1 58FC5C8D
P 8900 5800
F 0 "#PWR0308" H 8900 5550 50  0001 C CNN
...
Wire Wire Line
	8800 1500 8800 2100
$Comp
L power1:+3V3 #PWR0303
U 1 1 58FC70E1
P 2650 2100
F 0 "#PWR0303" H 2650 1950 50  0001 C CNN
...
Wire Wire Line
	2450 3200 2850 3200
$Comp
L power1:GND #PWR0304
U 1 1 58FC8063
P 2650 5800
F 0 "#PWR0304" H 2650 5550 50  0001 C CNN
...
$Comp
L power1:GND #PWR0301
U 1 1 58FC846A
P 1300 2550
F 0 "#PWR0301" H 1300 2300 50  0001 C CNN
...
Wire Wire Line
	1300 2550 1300 2500
$Comp
L power1:+3V3 #PWR0302
U 1 1 5900C7EB
P 1400 3150
F 0 "#PWR0302" H 1400 3000 50  0001 C CNN
...
Wire Wire Line
	8450 1800 9400 1800
$Comp
L power1:+3V3 #PWR0307
U 1 1 590237EC
P 8800 1500
F 0 "#PWR0307" H 8800 1350 50  0001 C CNN
...
$EndComp
$Comp
L usevolt:AL8805W5-7_LED_DRIVER U302
U 1 1 5A0D49FC
P 7100 1400
...
Wire Wire Line
	6700 1550 6250 1550
$Comp
L power1:GND #PWR0306
U 1 1 5A0D4BEC
P 6500 1650
F 0 "#PWR0306" H 6500 1400 50  0001 C CNN
...
$Comp
L power1:VEE #PWR0305
U 1 1 5A0D7248
P 6500 750
F 0 "#PWR0305" H 6500 600 50  0001 C CNN
...
$EndComp
$Comp
L usevolt:HEADER_MOLEX_52207-0433 J302
U 1 1 5A1297ED
P 8250 6150
...
Wire Wire Line
	6250 6350 8150 6350
$Comp
L usevolt:CAP_EEE-FK1H470P C304
U 1 1 5A12F27F
P 6250 1450
