...
void esb_init(esb_st *this) {
	...
	uv_canopen_sdo_write(ESB_NODE_ID, ESB_OILCOOLER_TRIGGER_INDEX, ESB_OILCOOLER_TRIGGER_SUBINDEX,
			CANOPEN_TYPE_LEN(ESB_OILCOOLER_TRIGGER_TYPE), &dspl.user->oilcooler_trigger_temp);
}
