...
void settings_show(void) {
	...
	this->tab_names[0] = uv_str(STR_SETTINGS_TABGENERAL);
	this->tab_names[1] = uv_str(STR_SETTINGS_TABVALVECONFS);
	this->tab_names[2] = uv_str(STR_SETTINGS_TABIMPLSETTINGS);
	...
	TOPIC_INIT(&this->window, &this->topic, uv_str(STR_LABELSETTINGS));
