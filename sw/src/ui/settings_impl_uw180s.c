...
static void show_general() {
	...
	uv_uislider_set_title(&this->general.rollers_grab_time, "Wheels\nGrab time");
	...
	uv_uislider_set_title(&this->general.blades_grab_time, "Delimbers\nGrab time");
...
static void show_sliders(uw180s_state_e state, const char *label) {
	...
	uv_uislider_set_title(&this->sliders.max_speed_n, "Backward max speed");
